   ...
   <%
    ...
    <%@include  file="navbar.html" %>
		...
		<div class="sidenav shadow p-3" style="background-color: #a3ddcb;">
		  	...
		  	<h4>Filters</h4>
   			...
   			<label class="sidenav_labels" for="exampleFormControlSelect1">Price</label><br> 
					...
					<button class="btn btn-danger" name="clearFilters" style="background-color: #03506f;">Clear</button>
					</div>
		</div>
		</form>
		</div>
      ...
      <div class="row" style="margin-left:5%">
        ...
        {%>	<input class="col-md-10 "type="text"placeholder="Search Products" aria-label="Search" name="search" style="height:40px;"><%
        } %>
           <button class="btn btn-danger site-btn" style="background-color: #03506f;">Search</button>
        </div>
      </div>
      </div>
